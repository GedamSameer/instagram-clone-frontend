    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="w-full max-w-md bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
        ...
        <form onSubmit={submit} className="flex flex-col gap-4">
          ...
          <button className="mt-2 bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 disabled:opacity-60" type="submit" disabled={loading}>{loading ? 'Logging in...' : 'Log in'}</button>
        </form>
