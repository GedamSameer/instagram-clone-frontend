...
export const getMessageRequests = () => api.get('/api/messages/requests')
...
export const acceptMessageRequest = (conversationId) => api.post(`/api/messages/conversations/${conversationId}/accept`)
export const rejectMessageRequest = (conversationId) => api.delete(`/api/messages/conversations/${conversationId}/request`)
